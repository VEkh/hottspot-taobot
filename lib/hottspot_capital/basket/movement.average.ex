defmodule HottspotCapital.Basket.Movement.Average do
  ...
  defp calculate_basket_movement(basket) do
    [from_average, to_average] =
      ...
      |> Enum.map(&vector_average/1)

    movement(from: from_average, to: to_average)
  end
