#ifndef OANDA__TAO_BOT_target_daily_profit_trailing_stop
#define OANDA__TAO_BOT_target_daily_profit_trailing_stop

#include "tao_bot.h" // Oanda::TaoBot, order_win_result_t
#include <algorithm> // std::max, std::min

double Oanda::TaoBot::target_daily_profit_trailing_stop() {
