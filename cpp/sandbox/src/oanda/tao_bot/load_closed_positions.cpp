#ifndef OANDA__TAO_BOT_load_closed_positions
#define OANDA__TAO_BOT_load_closed_positions
...
std::vector<Oanda::t::position_t> Oanda::TaoBot::load_closed_positions() {
