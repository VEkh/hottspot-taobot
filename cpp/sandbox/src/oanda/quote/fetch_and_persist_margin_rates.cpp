#ifndef OANDA__QUOTE_fetch_and_persist_margin_rates
#define OANDA__QUOTE_fetch_and_persist_margin_rates
...
void Oanda::Quote::fetch_and_persist_margin_rates(
  ...
  try {
    ...
    json instruments_json = ::utils::json::parse_with_catch(
        ...
        "OANDA__QUOTE_fetch_and_persist_margin_rates");
    ...
    std::string error_message = Formatted::error_message(
        std::string("[OANDA__QUOTE_fetch_and_persist_margin_rates]: "
