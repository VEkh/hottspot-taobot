#ifndef ALPACA__TAO_BOT_build_candlesticks
#define ALPACA__TAO_BOT_build_candlesticks

#include "lib/utils/time.cpp" // ::utils::time_
#include "tao_bot.h"          // Alpaca::TaoBot, candlestick_t, quote_t
#include <algorithm>          // std::max, std:min
#include <time.h>             // localtime, time_t, tm
#include <vector>             // std::vector

void Alpaca::TaoBot::build_candlesticks() {
  const int period = 60;
