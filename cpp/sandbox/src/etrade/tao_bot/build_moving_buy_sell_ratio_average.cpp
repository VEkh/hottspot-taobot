#ifndef ETRADE__TAO_BOT_build_moving_buy_sell_ratio_average
#define ETRADE__TAO_BOT_build_moving_buy_sell_ratio_average
...
ETrade::TaoBot::build_moving_buy_sell_ratio_average(
