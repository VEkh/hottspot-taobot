#if !defined ETRADE__STRADDLE_set_current_quote
#define ETRADE__STRADDLE_set_current_quote
...
json translate_quote(std::string response_body) {
...
void ETrade::Straddle::set_current_quote() {
