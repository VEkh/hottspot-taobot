# TODO: Properly test and extract commonalities with BuyRecommender
defmodule HottspotCapital.Basket.SellRecommender do
  ...
  defp apply_sell_filter(movements) do
    movements
    |> Enum.filter(fn
      %Movement{
        ...
        basket_movement < 0 &&
          ...
          basket_movement - reference_movement <= -1 * calculate_target_daily_return()
