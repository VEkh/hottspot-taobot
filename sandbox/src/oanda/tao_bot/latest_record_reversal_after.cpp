// TODO: Decide
#ifndef OANDA__TAO_BOT_latest_record_reversal_after
#define OANDA__TAO_BOT_latest_record_reversal_after
...
Oanda::TaoBot::reversal_t Oanda::TaoBot::latest_record_reversal_after(
