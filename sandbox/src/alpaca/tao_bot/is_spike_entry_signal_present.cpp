// TODO: Decide
#ifndef ALPACA__TAO_BOT_is_spike_entry_signal_present
#define ALPACA__TAO_BOT_is_spike_entry_signal_present

#include "tao_bot.h" // Alpaca::TaoBot, position_t, reversal_t, reversal_type_t

bool Alpaca::TaoBot::is_spike_entry_signal_present() {
